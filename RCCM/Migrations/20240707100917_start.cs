        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Candidate_Nationality_NationalityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassedExam = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamResult_Candidate_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "Candidate",
                        principalColumn: "CandidateId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamResult_ExamTypeConf_ExamTypeConfId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ExperienceMatch = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobOffer_Candidate_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "Candidate",
                        principalColumn: "CandidateId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AuditExamTypeConfId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    ExamTypeConfId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CreatorExamTypeConf", x => x.AuditExamTypeConfId);
                    table.ForeignKey(
                        name: "FK_CreatorExamTypeConf_ExamTypeConf_ExamTypeConfId",
                        column: x => x.ExamTypeConfId,
                        principalTable: "ExamTypeConf",
                        principalColumn: "ExamTypeConfId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CreatorExamTypeConf_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InterviewResult_Interview_InterviewId",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "CreatorExamTypeConf",
                column: "ExamTypeConfId");

            migrationBuilder.CreateIndex(
                name: "IX_CreatorExamTypeConf_UserId",
                table: "CreatorExamTypeConf",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamResult_ExamTypeConfId",
                table: "ExamResult",
                column: "ExamTypeConfId");
